    ...
    const columns = useMemo(
        () => [
            ...
            },
            {
                ...
                width: 160,
                renderCell: (params) => <p>{params.row.customer ? params.row.customer?.name : ""}</p>,
            },
            {
                field: "phone",
                headerName: "SĐT",
            ...
            },
            {
                ...
                headerName: "Ngày tạo",
                width: 160,
                renderCell: (params) => <span>{new Date(params.row.created_at).toLocaleString()}</span>,
            },
            {
                field: "action",
                headerName: "Thao tác",
        ...
        [name1]
    ); // Re-run useMemo when name1 changes
                                                    ...
                                                    <Card>
                                                        <Card.Body>
                                                            ...
                                                            <Form.Group className="mb-3" controlId="code">
                                                                ...
                                                                <Form.Control type="text" value={specificData?.date || "Không có mã hóa đơn"} readOnly disabled />
                                                            </Form.Group>
                                                            <Form.Group className="mb-3" controlId="code">
                                                                <Form.Label>Tổng doanh thu</Form.Label>
                                                                <Form.Control type="text" value={formatPrice(specificData?.total) || 0} readOnly disabled />
                                                            </Form.Group>
                                                            <Row className="row-gap-3">
