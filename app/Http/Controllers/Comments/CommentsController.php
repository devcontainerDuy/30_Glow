...
class CommentsController extends Controller
{
    ...
    public function index()
    {
        ...
        $this->data = $this->model::with('parent', 'product', 'service', 'customer', 'user')->get();
        $trashs = $this->model::with('parent', 'product', 'service', 'customer', 'user')->onlyTrashed()->get();
        return Inertia::render('Comments/Index', ['comment' => $this->data, 'trashs' => $trashs, 'crumbs' => $this->crumbs]);
    }

    /**
     * Thêm mới bình luận ở cms
